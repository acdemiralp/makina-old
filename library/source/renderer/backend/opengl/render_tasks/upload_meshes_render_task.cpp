...
fg::render_task<upload_meshes_task_data>* add_upload_meshes_render_task(renderer* framegraph)
{
  ...
  const auto retained_vertices            = framegraph->add_retained_resource<buffer_description, gl::buffer>           ("Mesh Vertices"           , buffer_description{configuration::instance().get<GLsizeiptr>("rendering.upload_meshes_render_task.vertex_buffer_size"            , 128e+6)});
  const auto retained_normals             = framegraph->add_retained_resource<buffer_description, gl::buffer>           ("Mesh Normals"            , buffer_description{configuration::instance().get<GLsizeiptr>("rendering.upload_meshes_render_task.normal_buffer_size"            , 128e+6)});
  const auto retained_colors              = framegraph->add_retained_resource<buffer_description, gl::buffer>           ("Mesh Colors"             , buffer_description{configuration::instance().get<GLsizeiptr>("rendering.upload_meshes_render_task.color_buffer_size"             , 128e+6)});
  const auto retained_texture_coordinates = framegraph->add_retained_resource<buffer_description, gl::buffer>           ("Mesh Texture Coordinates", buffer_description{configuration::instance().get<GLsizeiptr>("rendering.upload_meshes_render_task.texture_coordinate_buffer_size", 128e+6)});
  const auto retained_bone_ids            = framegraph->add_retained_resource<buffer_description, gl::buffer>           ("Mesh Bone Ids"           , buffer_description{configuration::instance().get<GLsizeiptr>("rendering.upload_meshes_render_task.bone_id_buffer_size"           , 128e+6)});
  const auto retained_bone_weights        = framegraph->add_retained_resource<buffer_description, gl::buffer>           ("Mesh Bone Weights"       , buffer_description{configuration::instance().get<GLsizeiptr>("rendering.upload_meshes_render_task.bone_weight_buffer_size"       , 128e+6)});
  const auto retained_instance_attributes = framegraph->add_retained_resource<buffer_description, gl::buffer>           ("Mesh Instance Attributes", buffer_description{configuration::instance().get<GLsizeiptr>("rendering.upload_meshes_render_task.instance_attribute_buffer_size", 128e+6)});
  const auto retained_indices             = framegraph->add_retained_resource<buffer_description, gl::buffer>           ("Mesh Indices"            , buffer_description{configuration::instance().get<GLsizeiptr>("rendering.upload_meshes_render_task.index_buffer_size"             , 128e+6)});
  const auto retained_draw_calls          = framegraph->add_retained_resource<buffer_description, gl::buffer>           ("Mesh Draw Calls"         , buffer_description{configuration::instance().get<GLsizeiptr>("rendering.upload_meshes_render_task.draw_call_buffer_size"         , 16e+6 )});
  const auto retained_transforms          = framegraph->add_retained_resource<buffer_description, gl::buffer>           ("Mesh Transforms"         , buffer_description{configuration::instance().get<GLsizeiptr>("rendering.upload_meshes_render_task.transform_buffer_size"         , 16e+6 )});
  const auto retained_materials           = framegraph->add_retained_resource<buffer_description, gl::buffer>           ("Mesh Materials"          , buffer_description{configuration::instance().get<GLsizeiptr>("rendering.upload_meshes_render_task.material_buffer_size"          , 16e+6 )});
  const auto retained_rigs                = framegraph->add_retained_resource<buffer_description, gl::buffer>           ("Mesh Rigs"               , buffer_description{configuration::instance().get<GLsizeiptr>("rendering.upload_meshes_render_task.rig_buffer_size"               , 16e+6 )});
