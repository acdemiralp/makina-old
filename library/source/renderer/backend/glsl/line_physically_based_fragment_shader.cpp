...
namespace glsl
{
std::string line_physically_based_fragment_shader = R"(
#version 450
...
void main()
{
  ...
  output_color.a *= smoothstep(1.0f, 1.0f - (antialiasing / fs_input.radius), abs(fs_input.edge_distance) / fs_input.radius);
}
)";
}
}