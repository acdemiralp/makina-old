#include <makina/core/rendering/backends/opengl/vertex_array.hpp>
...
{
  return get_attribute_parameter(index, GL_VERTEX_ATTRIB_ARRAY_ENABLED);
}
...
{
  return get_attribute_parameter(index, GL_VERTEX_ATTRIB_ARRAY_NORMALIZED);
}
bool    vertex_array::attribute_integer              (GLuint index) const
{
  return get_attribute_parameter(index, GL_VERTEX_ATTRIB_ARRAY_INTEGER);
}
bool    vertex_array::attribute_long                 (GLuint index) const
{
  return get_attribute_parameter(index, GL_VERTEX_ATTRIB_ARRAY_LONG);
}
