#include <makina/core/rendering/backends/opengl/per_fragment_ops.hpp>
...
{
  return glIsEnabledi(GL_SCISSOR_TEST, index);
}
...
void set_sample_coverage                 (GLfloat value, bool invert)
{
...
void set_stencil_function    (GLenum function, GLint reference_value, GLuint mask, GLenum face)
{
  glStencilFuncSeparate(face, function, reference_value, mask);
}
void set_stencil_operation   (GLenum stencil_fail, GLenum depth_fail, GLenum depth_success, GLenum face)
{
...
void set_depth_function    (GLenum function)
{
...
void set_blend_equation  (GLenum rgb_mode  , GLenum alpha_mode )
{
  glBlendEquationSeparate(rgb_mode, alpha_mode);
}
void set_blend_function  (GLenum source    , GLenum destination)
{
  glBlendFunc(source, destination);
}
void set_blend_function  (GLenum source_rgb, GLenum source_alpha, GLenum destination_rgb, GLenum destination_alpha)
{
...
void set_indexed_blend_equation  (GLuint index, GLenum mode)
{
  glBlendEquationi(index, mode);
}
void set_indexed_blend_equation  (GLuint index, GLenum rgb_mode  , GLenum alpha_mode  )
{
  glBlendEquationSeparatei(index, rgb_mode, alpha_mode);
}
void set_indexed_blend_function  (GLuint index, GLenum source    , GLenum destination )
{
  glBlendFunci(index, source, destination);
}
void set_indexed_blend_function  (GLuint index, GLenum source_rgb, GLenum source_alpha, GLenum destination_rgb, GLenum destination_alpha)
{
...
void set_logic_operation        (GLenum operation)
{
  glLogicOp(operation);
}
}
