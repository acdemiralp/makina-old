#ifndef MAKINA_RENDERER_BACKEND_OPENGL_TEXTURE_HPP
#define MAKINA_RENDERER_BACKEND_OPENGL_TEXTURE_HPP
...
template<>
inline std::unique_ptr<gl::texture_1d>       fg::realize(const mak::opengl::texture_description& description)
{
...
template<>
inline std::unique_ptr<gl::texture_2d>       fg::realize(const mak::opengl::texture_description& description)
{
...
template<>
inline std::unique_ptr<gl::texture_3d>       fg::realize(const mak::opengl::texture_description& description)
{
...
template<>
inline std::unique_ptr<gl::texture_1d_array> fg::realize(const mak::opengl::texture_description& description)
{
...
template<>
inline std::unique_ptr<gl::texture_2d_array> fg::realize(const mak::opengl::texture_description& description)
{
