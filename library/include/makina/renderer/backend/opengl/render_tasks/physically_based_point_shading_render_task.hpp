#ifndef MAKINA_RENDERER_BACKEND_OPENGL_RENDER_TASKS_PHYSICALLY_BASED_POINT_SHADING_RENDER_TASK_HPP_
#define MAKINA_RENDERER_BACKEND_OPENGL_RENDER_TASKS_PHYSICALLY_BASED_POINT_SHADING_RENDER_TASK_HPP_
...
namespace opengl
{
struct MAKINA_EXPORT physically_based_point_shading_task_data
{
...
MAKINA_EXPORT fg::render_task<physically_based_point_shading_task_data>* add_physically_based_point_shading_render_task(
  renderer*                      framegraph , 
  framebuffer_resource*          target     , 
