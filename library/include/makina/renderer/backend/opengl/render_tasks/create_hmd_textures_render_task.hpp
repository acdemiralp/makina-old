#ifndef MAKINA_RENDERER_BACKEND_OPENGL_RENDER_TASKS_CREATE_HMD_TEXTURES_RENDER_TASK_HPP_
#define MAKINA_RENDERER_BACKEND_OPENGL_RENDER_TASKS_CREATE_HMD_TEXTURES_RENDER_TASK_HPP_
