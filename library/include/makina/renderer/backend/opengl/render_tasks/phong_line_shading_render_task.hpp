#ifndef MAKINA_RENDERER_BACKEND_OPENGL_RENDER_TASKS_PHONG_LINE_SHADING_RENDER_TASK_HPP_
#define MAKINA_RENDERER_BACKEND_OPENGL_RENDER_TASKS_PHONG_LINE_SHADING_RENDER_TASK_HPP_
...
namespace opengl
{
struct MAKINA_EXPORT phong_line_shading_task_data
{
...
MAKINA_EXPORT fg::render_task<phong_line_shading_task_data>* add_phong_line_shading_render_task(
  renderer*                      framegraph , 
  framebuffer_resource*          target     , 
