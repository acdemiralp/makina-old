#ifndef MAKINA_RENDERER_BACKEND_OPENGL_RENDER_TASKS_PHONG_LINE_SHADING_RENDER_TASK_HPP
#define MAKINA_RENDERER_BACKEND_OPENGL_RENDER_TASKS_PHONG_LINE_SHADING_RENDER_TASK_HPP
