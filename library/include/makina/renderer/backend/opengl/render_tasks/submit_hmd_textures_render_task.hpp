#ifndef MAKINA_RENDERER_BACKEND_OPENGL_RENDER_TASKS_SUBMIT_HMD_TEXTURES_RENDER_TASK_HPP
#define MAKINA_RENDERER_BACKEND_OPENGL_RENDER_TASKS_SUBMIT_HMD_TEXTURES_RENDER_TASK_HPP
