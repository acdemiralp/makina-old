#ifndef MAKINA_RENDERER_BACKEND_OSPRAY_RENDER_TASKS_RAYTRACING_RENDER_TASK_HPP
#define MAKINA_RENDERER_BACKEND_OSPRAY_RENDER_TASKS_RAYTRACING_RENDER_TASK_HPP
