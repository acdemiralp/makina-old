#ifndef MAKINA_RENDERER_BACKEND_OSPRAY_RENDER_TASKS_OPENGL_ADAPTER_RENDER_TASK_HPP
#define MAKINA_RENDERER_BACKEND_OSPRAY_RENDER_TASKS_OPENGL_ADAPTER_RENDER_TASK_HPP
