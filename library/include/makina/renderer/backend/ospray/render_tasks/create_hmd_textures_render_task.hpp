#ifndef MAKINA_RENDERER_OSPRAY_RENDER_TASKS_CREATE_HMD_TEXTURES_RENDER_TASK_HPP
#define MAKINA_RENDERER_OSPRAY_RENDER_TASKS_CREATE_HMD_TEXTURES_RENDER_TASK_HPP
