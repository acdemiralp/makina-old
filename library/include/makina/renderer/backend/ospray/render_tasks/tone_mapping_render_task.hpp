#ifndef MAKINA_RENDERER_BACKEND_OSPRAY_RENDER_TASKS_TONE_MAPPING_RENDER_TASK_HPP_
#define MAKINA_RENDERER_BACKEND_OSPRAY_RENDER_TASKS_TONE_MAPPING_RENDER_TASK_HPP_
