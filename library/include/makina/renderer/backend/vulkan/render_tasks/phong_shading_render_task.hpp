#ifndef MAKINA_RENDERER_BACKEND_VULKAN_RENDER_TASKS_PHONG_SHADING_RENDER_TASK_HPP
#define MAKINA_RENDERER_BACKEND_VULKAN_RENDER_TASKS_PHONG_SHADING_RENDER_TASK_HPP
