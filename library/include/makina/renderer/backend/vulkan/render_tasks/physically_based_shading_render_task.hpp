#ifndef MAKINA_RENDERER_BACKEND_VULKAN_RENDER_TASKS_PHYSICALLY_BASED_SHADING_RENDER_TASK_HPP_
#define MAKINA_RENDERER_BACKEND_VULKAN_RENDER_TASKS_PHYSICALLY_BASED_SHADING_RENDER_TASK_HPP_
