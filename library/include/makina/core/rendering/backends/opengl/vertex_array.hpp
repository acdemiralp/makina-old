#ifndef MAKINA_CORE_RENDERING_BACKENDS_OPENGL_VERTEX_ARRAY_HPP_
#define MAKINA_CORE_RENDERING_BACKENDS_OPENGL_VERTEX_ARRAY_HPP_
...
namespace gl
{
class MAKINA_EXPORT vertex_array
{
public:
