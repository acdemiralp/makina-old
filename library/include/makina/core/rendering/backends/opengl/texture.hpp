#ifndef MAKINA_CORE_RENDERING_BACKENDS_OPENGL_TEXTURE_HPP_
#define MAKINA_CORE_RENDERING_BACKENDS_OPENGL_TEXTURE_HPP_
...
#include <makina/core/rendering/backends/opengl/renderbuffer.hpp>
...
MAKINA_EXPORT inline void set_seamless_cubemap_enabled(bool enabled)
{
  enabled ? glEnable(GL_TEXTURE_CUBE_MAP_SEAMLESS) : glDisable(GL_TEXTURE_CUBE_MAP_SEAMLESS);
}
MAKINA_EXPORT inline bool seamless_cubemap_enabled    ()
{
