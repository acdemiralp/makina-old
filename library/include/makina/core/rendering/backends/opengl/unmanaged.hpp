#ifndef MAKINA_CORE_RENDERING_BACKENDS_OPENGL_UNMANAGED_HPP_
#define MAKINA_CORE_RENDERING_BACKENDS_OPENGL_UNMANAGED_HPP_
...
struct MAKINA_EXPORT unmanaged_t
{
